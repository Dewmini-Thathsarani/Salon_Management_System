...
?>
                        ...
                        <address>
                           ...
                           <br>
                            ...
                            <strong><i class="fa fa-phone-square"></i> Phone no:</strong> <a href="tel:0452263437"><?php echo $row['MobileNumber']; ?></a>

                        </address>
                        <address>
                            <strong> <i class="fa fa-envelope"></i> Email: </strong>
                            <a href="beautysalon@gmail.com"><?php  echo $row['Email'];?></a>
